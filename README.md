...
```bash
cd tf-caffe-pytorch
nvidia-docker build -t kertansul/dl-docker:gpu -f Dockerfile.gpu .
```
...
**GPU Version**
```bash
nvidia-docker run -it -p 8888:8888 -p 6006:6006 -v /sharedfolder:/root/sharedfolder kertansul/dl-docker:gpu bash
```
